...
def decoder_layer(encoder_outputs, encoder_states, decoder_inputs, target_sequence_len,
    ...
    # lstm layer 
    def get_lstm(rnn_size): # bidirectional rnn, rnn_size*2
